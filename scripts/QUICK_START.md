...
## 🔥 САМЫЙ ПРОСТОЙ СПОСОБ: Всё в Colab

**Ничего не нужно скачивать на свой ПК!**

### Просто открой и запусти:
```
https://colab.research.google.com/github/nem1k9/cs2-bot-training/blob/main/CS2_Bot_Training_All_In_One.ipynb
```

**Что делает:**
- ✅ Скачивает демки с HLTV прямо в Colab
- ✅ Парсит и обучает модель
- ✅ Сохраняет результаты на Drive

**Время:** ~3-5 часов (всё автоматически)

---

## 📦 Альтернатива: Сжатые демки (если хочешь контроль)
